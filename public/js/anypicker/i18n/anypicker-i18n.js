 ...
 */
 ...
 (function ($) {
     $j.AnyPicker.i18n["ko-kr"] = $j.extend($j.AnyPicker.i18n["ko-kr"], {
    ...
    headerTitle: "날짜선택",
         ...
         veryShortDays: "일_월_화_수_목_금_토".split("_"),
 		shortDays: "일_월_화_수_목_금_토".split("_"),
 		fullDays: "일요일_월요일_화요일_수요일_목요일_금요일_토요일".split("_"),
...
(function ($) {
    $j.AnyPicker.i18n["de-at"] = $j.extend($j.AnyPicker.i18n["de-at"], {
...
(function ($) {
    $j.AnyPicker.i18n["de"] = $j.extend($j.AnyPicker.i18n["de"], {
...
(function ($) {
    $j.AnyPicker.i18n["en"] = $j.extend($j.AnyPicker.i18n["en"], {
...
(function ($) {
    $j.AnyPicker.i18n["fr"] = $j.extend($j.AnyPicker.i18n["fr"], {
...
(function ($) {
    $j.AnyPicker.i18n["nb"] = $j.extend($j.AnyPicker.i18n["nb"], {
...
(function ($) {
    $j.AnyPicker.i18n["ru"] = $j.extend($j.AnyPicker.i18n["ru"], {
...
(function ($) {
    $j.AnyPicker.i18n["zh-cn"] = $j.extend($j.AnyPicker.i18n["zh-cn"], {
