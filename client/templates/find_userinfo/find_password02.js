//비밀번호 휴대전화로 찾기
var instance;
Template.findPassword02.onRendered(function(){
  $(window).scrollTop(0);
  instance = this;
...
Template.findPassword02.events({
  ...
  "click #findPasswdNextPage":function(e,t){
    e.preventDefault();
...
Template.findPassword02.onDestroyed(function(){
  clearInterval(x);
  timeLimit = false;
  document.getElementById("phoneAuthInput").placeholder = "";
});
